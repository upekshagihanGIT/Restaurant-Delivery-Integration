...
# %%
    ...
    epochs_list = [300, 350, 400]
    num_layers_list = [7, 8, 9]
    ...
    combinations1 = itertools.product(
        hidden_sizes, learning_rates, epochs_list, num_layers_list, lstm_dropout_list, fc_dropout_list
    ) 
    ...
    # %%
    for hidden_size, lr, epochs, num_layers, lstm_dropout, fc_dropout in combinations1:
        ...
        for epoch in range(epochs):         
            ...
            with torch.no_grad():
                ...
                if val_loss.item() < best_accuracy:
                    ...
                    best_params = (hidden_size, lr, epochs, num_layers, lstm_dropout, fc_dropout)
